...
function doGetNodeStatus() { 
    ...
    console.log(' doGetNodeStatus!!');
    web3.net.getListening(function(error, result){
        console.log(' getListening1!!');
        if(error) setData('node_syncing_status',error,true);
        else {
            console.log('node_syncing_status!!');
            web3.eth.getSyncing(function(error, result){
                if(error){
                    setData('node_syncing_status', error, true); 
                } else {
                    console.log('result node_syncing: '+result);
                    setData('node_syncing_status','Syncing Status: '+result, false);
                }
            });
        }
    });
            ...
            web3.eth.getMining(function(error, result){
                if(error){
                    ...
                    setData('node_mining_status','Mining Status: '+result, false);
                }
            });
